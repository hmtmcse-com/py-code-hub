...
workbook = xlsxwriter.Workbook("Student_Marksheet_v2.xlsx")
...
# 1. REMOVE SHEET GRIDLINES (Hides gridlines everywhere except styled tables)
...
# 2. COLUMN WIDTH SETUP (Increased width on Column A to fit "Class & Sec:")
worksheet.set_column("A:A", 14)  # Expanded for labels
worksheet.set_column("B:B", 24)  # Subject
worksheet.set_column("C:C", 14)  # Full Marks
worksheet.set_column("D:D", 14)  # Pass Marks / Roll No Label
worksheet.set_column("E:E", 16)  # Marks Obtained / Date of Birth Label
worksheet.set_column("F:F", 14)  # Grade
worksheet.set_column("G:G", 14)  # Status
...
worksheet.write("D6", "Roll No:", meta_label_fmt)
worksheet.write("E6", "1024", meta_val_fmt)

worksheet.write("A7", "Class & Sec:", meta_label_fmt)
worksheet.merge_range("B7:C7", "Grade 10 - A", meta_val_fmt)

worksheet.write("D7", "Date of Birth:", meta_label_fmt)
worksheet.write("E7", "14/05/2010", meta_val_fmt)
